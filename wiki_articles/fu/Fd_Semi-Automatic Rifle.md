# [FU] Fd:Semi-Automatic Rifle

**来源**: Frackin' Universe Wiki | **分类**: Imported | **链接**: https://frackinuniverse.miraheze.org/wiki/Fd:Semi-Automatic_Rifle

---

**Semi-Automatic Rifle **is a two-handed procedurally generated ranged weapon model.

It can be common, uncommon, and rare. Common Semi-Automatic Rifles will shoot bullets, while uncommon and rare ones will shoot elemental plasma shots.

Note: though Sniper Rifles (re-named to Semi-Automatic Rifles in Frackin' Universe) are part of vanilla *Starbound*, their characteristics are modified significantly by Frackin' Universe. For the unmodified characteristics, consult the official *Starbound* wiki, Starbounder (http://starbounder.org/).

## Base Statistics
- **Base DPS: **8.0-9.0 health/s (Common), 8.5-9.5 health/s (Uncommon/Rare)
- **Fire Time: **0.3-1.25 seconds between shots (0.8-3.3 shots/s)
- **Energy Usage: **24.0-27.0 energy/s (Common), 28.5-31.5 energy/s (Uncommon/Rare)
- **Knockback: **10-20 (weak to average knockback)
- **Crit Chance: **6%
- **Base Crit Damage Bonus: **+6 damage (Common), +7 damage (Uncommon/Rare)

## Elemental Damage
Uncommon and rare Semi-Automatic Rifles are assigned one of seven elements (non-physical damage types) on generation. Both uncommon and rare variants will inflict status effects with special attacks. For all elements, only rare Semi-Automatic Rifles will inflict the appropriate elemental status effect with the primary attack.
...
## Special Attacks
Semi-Automatic Rifles, like most two-handed weapon types, can generate with one of a variety of special attacks.
...
| Explosive Bubbles | explosivebubbles | Y | Y | Y |
